...
class NewfeatureVerisonCodeChip extends ConsumerWidget {

  final VersionCodeEntity versionCode;

  const NewfeatureVerisonCodeChip({super.key, required this.versionCode});

  @override
  Widget build(BuildContext context,ref) {

    final selectedFormVersionCode = ref.watch(formProvider).versionCode;
    ...
    return MouseRegion(
      ...
      child: GestureDetector(
        ...
        onTap: () {
          ref.read(formProvider.notifier).updateVersionCode(value: versionCode.id);
        },
