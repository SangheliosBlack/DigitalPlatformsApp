...
class FeaturesSendYourIdeasScreen extends StatelessWidget {

  static const String path = "/admin/features/send_your_ideas";

  static const int status = 3;

  const FeaturesSendYourIdeasScreen({super.key});
