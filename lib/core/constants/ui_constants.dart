class UiConstants {
  ...
  static String invalidPassword = "Contraseña invalida";
  static String notFoundPage404 = "404";
  ...
  static String currentUsersWidget = "Equipo";
  static String inviteMember = "Agregar";
